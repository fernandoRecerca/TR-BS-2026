...
El primer pas va consistir en fer una cerca de material específic per preparar l'examen de MACs a les PAU per a alumnes que ja tenen la preparació per a preparar-se per a la prova de MAT. Els manuals existents són llargs i feixucs, expliquem moltes coses que l'alumne ja sap i altres que són sobreres i que no sortiran a la prova PAU.

\textbf{Ara segueix tu...}
