...
Un cop detectat el problema que hi ha per a la preparació de l'examen de les PAU de les Matemàtiques Aplicades a les Ciències Socials per als estudiants del científic, vaig fer una recerca de la informació que hi havia per a buscar material específic de preparació per aquest examen. Només vaig trobar material general en què expliquen molta teoria. Llavors, aquí va ser on vaig voler centrar el meu treball, preparar als alumnes per a assolir la màxima nota a l'examen i millorar els seus coneixements sobre la probabilitat i estadística, centrant-me molt més en la part pràctica d'exercicis i no tant en la part teòrica, ja que la teoria es pot trobar en molts llocs, però exercicis concrets com els que hi ha a les PAU són més difícils de trobar, aquí és on el meu treball destaca.

\section{Organització i aprenentatge}
El temari que volia explicar són temes que mai havia estudiat, així que vaig haver d'aprendre'l primer i després explicar. Vaig estudiar i practicar exercicis amb el llibre de MACs II, amb vídeos per internet i amb explicacions del Fernando Garcia, el meu tutor de TR. Va ser un procés difícil perquè no estava acostumat a estudiar temes sencers pel meu compte, sense cap guia ni planificació, però que val la pena per tot el potencial que té i per a totes les persones que els hi puc facilitar feina i estalviar temps.
...
\chapter{Eines}
\label{c:eines}
Cito el treball de recerca del Max Pérez en el que explica les eines utilitzades:
