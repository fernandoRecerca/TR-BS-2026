...
Càlcul de probabilitats resolts
Exercici 1:
...
Exercicis a resoldre:
    ...
    8) El temps de reacció d'un grup de conductors segueix $N(0,75, 0,12)$ segons. Quina és la probabilitat que un conductor tingui un temps de reacció superior a $0,9$ s?
    ...
    11) PAU Catalunya, Matemàtiques Aplicades a les Ciències Socials, convocatòria ordinària de 2025 (juny), sèrie 1, exercici 6a.
    Enunciat (adaptat): El pes de les vaques frisones d'una granja segueix una distribució normal amb una mitjana de 580 kg i una desviació típica de 25 kg. Calculeu la probabilitat que, si triem a l'atzar una vaca frisona d'aquesta granja, el seu pes estigui entre 531 i 629 kg.
