...
\fancyhead[LE,RO]{Institut Sants}
...
Finalment trobareu un solucionari de proves PAU pensat per ajudar a la preparació per a la prova.
...
\input{./ExercicisPAU/exercicisPAU.tex}
